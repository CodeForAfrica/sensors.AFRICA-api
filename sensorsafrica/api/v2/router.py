...
from .views import SensorDataStatView, CityView, NodesView, SensorsLocationView, SensorsTypeView, SensorsView
...
sensors_type_router = routers.DefaultRouter()
sensors_type_router.register(r"", SensorsTypeView, basename="sensors_type")
...
api_urls = [
    ...
    url(r"sensors-type/", include(sensors_type_router.urls)),
]
