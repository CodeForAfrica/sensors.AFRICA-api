...
class TestGettingData:
    def test_getting_air_data_now(self, client):
        response = client.get(
    ...
    def test_getting_air_data_now_all_cities(self, client):
    ...
    def test_getting_air_data_now_filter_cities(self, client):
        response = client.get(
    ...
    def test_getting_air_data_value_type(self, client):
        response = client.get(
    ...
    def test_getting_air_data_from_date(self, client):
        response = client.get(
    ...
    def test_getting_air_data_from_date_to_date(self, client):
        now = timezone.now()
        response = client.get(
    ...
    def test_getting_air_data_with_invalid_request(self, client):
        response = client.get(
    ...
    def test_getting_air_data_with_invalid_from_request(self, client):
        response = client.get(
    ...
    def test_getting_air_data_with_invalid_to_request(self, client):
        response = client.get(
