...
class TestGettingData:
    def test_getting_air_data_now(self, client, sensorsdatastats):
        ...
        assert result["P1"][0]["maximum"] == 0.0
        assert result["P1"][0]["minimum"] == 0.0
        ...
        assert result["P2"][0]["average"] == 2.75

        assert result["P2"][0]["maximum"] == 8.0
        assert result["P2"][0]["minimum"] == 0.0
